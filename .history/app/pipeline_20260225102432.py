...
class ChatbotPipeline:
    ...
    def _generate_table_summaries(self):
        ...
        # ============================================================================
        #LLAMAINDEX v0.11+ PATTERN: Use llm.structured_predict() instead of
        ...
        for table_info, df in zip(table_info_list, dfs):
            ...
            if existing:
                ...
                while attempts < 3:
                    try:
                        # Use llm.structured_predict instead of program()
    ...
    def run_query(self, user_query: str, memory: Optional[Any] = None, session_id: str = "default") -> str:
        ...
        try:
            ...
            if history_summary.summary != "No previous conversation":
                # FIXED: Include the actual previous SQL for accurate follow-up queries
                last_sql = ""
                ...
                if last_sql:
                    enriched_query = (
                        ...
                        f"[Previous SQL (for reference - use exact column names and values from this)]:\n"
                        f"```sql\n{last_sql}\n```\n\n"
                        f"[Current Question]\n{user_query}"
                    )
                else:
