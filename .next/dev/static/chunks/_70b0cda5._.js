...
'use client';
;
function Sidebar({ onNewChat, onClose }) {
...
'use client';
;
function ChatHeader({ connected, onMenuToggle }) {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
"[project]/components/WelcomeScreen.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function MessageBubble({ message }) {
    ...
    const formatted = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatMessageContent"])(content);
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: `message ${sender}-message${isError ? ' error-message' : ''}`,
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "message-avatar",
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("i", {
                    className: sender === 'user' ? 'fas fa-user' : 'fas fa-robot'
                }, void 0, false, {
...
'use client';
;
function InputArea({ value, onChange, onSend, isLoading, variant }) {
    _s();
...
'use client';
;
function ErrorToast({ visible, message, onClose }) {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$WelcomeScreen$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/WelcomeScreen.tsx [app-client] (ecmascript)");
...
function getOrCreateSessionId() {
    ...
    if (!id) {
        id = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["generateUUID"])();
...
function ChatApp() {
    ...
    const scrollToBottom = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ChatApp.useCallback[scrollToBottom]": ()=>{
    ...
    const showErrorToast = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ChatApp.useCallback[showErrorToast]": (message)=>{
            setToast({
                visible: true,
                message
            });
            setTimeout({
                "ChatApp.useCallback[showErrorToast]": ()=>setToast({
                        visible: false,
                        message: ''
                    })
            }["ChatApp.useCallback[showErrorToast]"], 5000);
        }
    }["ChatApp.useCallback[showErrorToast]"], []);
    const checkConnection = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ChatApp.useCallback[checkConnection]": async ()=>{
            try {
    ...
    }["ChatApp.useCallback[checkConnection]"], [
        showErrorToast
    ]);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ChatApp.useEffect": ()=>{
            ...
            return ({
                "ChatApp.useEffect": ()=>clearInterval(interval)
            })["ChatApp.useEffect"];
        }
    }["ChatApp.useEffect"], [
        checkConnection
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ChatApp.useEffect": ()=>{
            const onVisible = {
                "ChatApp.useEffect.onVisible": ()=>{
                    if (!document.hidden) checkConnection();
                }
            }["ChatApp.useEffect.onVisible"];
            const onOnline = {
                "ChatApp.useEffect.onOnline": ()=>checkConnection()
            }["ChatApp.useEffect.onOnline"];
            const onOffline = {
                "ChatApp.useEffect.onOffline": ()=>{
                    setConnected(false);
    ...
    function clearChat() {
        const newId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["generateUUID"])();
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                id: "chatMessages",
                                children: !hasMessages ? /* Empty state: welcome + centered input */ /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "chat-center-wrapper",
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$WelcomeScreen$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {}, void 0, false, {
                                            fileName: "[project]/components/ChatApp.tsx",
                                            lineNumber: 182,
                                            columnNumber: 17
                                        }, this),
...
_s(ChatApp, "9PU4W42E6kOeV0M9aQlp+y8yG5o=");
_c = ChatApp;
var _c;
...
//# sourceMappingURL=_70b0cda5._.js.map